...
class SocialGetPostsCommentsSuccessState extends SocialStates {}

class SocialCommentButtonChangedState extends SocialStates {}

class SocialGetPostsCommentsErrorState extends SocialStates {
  final String error;

  SocialGetPostsCommentsErrorState(this.error);
}
